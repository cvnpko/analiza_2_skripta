...
Motivacija za uvođenje pojma određenog integrala je računanje površine figura
ograničenih funkcijama $x=a$, $x=b$, $y=0$ i $f: [a,b]\longrightarrow$.
$\varphi\in\{ (x,y)\in\mathbb{R}^2 | a\leq x\leq b, 0\leq y\leq f(x)\}$.

Neka je $f: [a,b] \longrightarrow [0, +\infty)$ neprekidna funkcija, i neka je $\varphi = \{ (x, y) \in \mathbb{R}^2 | a \leq x \leq f(x)\}$\\
P($\varphi$) je povrsina figure $\varphi$\\
...
$P(\varphi) = \frac{1}{3}$ Kasnije ćemo zapisivati $\displaystyle \int_0^1 x^2\text{dx} = \frac{x^3}{3} \Bigg|^1_{x=0} = \frac{1}{3} - 0$\\
...
Primetimo da je $P(t)$ funkcija koja slika $[a, b]$ u $[0, +\infty]$ tj. $P(a) = 0$ i $P(b)$ je površina figure $\varphi$.\\
...
Neka je $f:[a,b]\longrightarrow\mathbb{R}$. Želimo da definišemo $\displaystyle\int_{a}^{b}f(x)dx$.\par
\begin{defbox}
    \begin{definicija}
...
\begin{defbox}
    \begin{definicija}
        ...
        $\sigma(f,\mathcal{P},\xi)=\sum_{i=1}^{n}f(\xi_i)\varDelta x_i$ nazivamo \textbf{integralna suma} funkije $f$ za datu podelu
...
\begin{defbox}
    ...
    \begin{definicija}
        ...
        $$I=\lim_{\lambda(\mathcal{P})\rightarrow 0}\sigma(f,\mathcal{P},\xi)=\int_{a}^{b}f(x)dx$$
...
\begin{stavbox}
    ...
    \end{stav}
    Dovoljno je dokazati slučaj kad je skup podeonih tačaka podele $\mathcal{P}$
...
\begin{defbox}
    \begin{definicija}
        ...
        $$\underline{\int_{a}^{b}}f(x)dx=sup\{s(f,P)\big|\mathcal{P}\in\mathcal{P}[a,b]\}.$$
    \end{definicija}
\end{defbox}
Za $f: [a,b]\longrightarrow\mathbb{R}$ skup $\{S(f,P)\big|\mathcal{P}\in\mathcal{P}[a,b]\}$
...
\begin{defbox}
    \begin{definicija}
        ...
        $$\overline{\int_{a}^{b}}f(x)dx=inf\{S(f,P)\big|\mathcal{P}\in\mathcal{P}[a,b]\}.$$
    \end{definicija}
\end{defbox}

Jasno je da važi $\displaystyle\underline{\int_{a}^{b}}f(x)dx\leq\overline{\int_{a}^{b}}f(x)dx$.

\begin{defbox}
    \label{definicija_2.8}
    \begin{definicija}
        Ako važi da je $\displaystyle\underline{\int_{a}^{b}}f(x)dx=\overline{\int_{a}^{b}}f(x)dx=I$,
...
\begin{teoremabox}
    ...
    \end{teorema}
\end{teoremabox}
Bez umanjenja opštosti pretpostavimo da je funkcija monotono rastuća na $[a, b]$.
...
\begin{defbox}
    \begin{definicija}
        ...
        $\varphi$ nazivamo integral sa promenljivom gornjom granicom.
    \end{definicija}
\end{defbox}
...
\begin{teoremabox}
    \begin{teorema}
        Ako je funkcija $f$ neprekidna na $[a, b]$ onda je funkcija $\varphi$
        diferencijabilna (i neprekidna) na $[a, b]$ i za svako $x \in (a, b)$ važi
        $\varphi'(x) = f(x)$ i važi $\varphi_+'(a) = f(a)$ i $\varphi'_-(b) = f(b)$.
    \end{teorema}
\end{teoremabox}
...
\begin{teoremabox}
    ...
    \end{teorema}
\end{teoremabox}
Neka je $\varphi: [a, b] \longrightarrow \mathbb{R}$ definisana sa $\varphi(x) = \displaystyle\int^x_a f(t)\text{dt}$. Na osnovu prethodnih teorema znamo da za svako $x\in [a, b]$ važi $\varphi'(x) = f(x)$ tj $\varphi$ je primitivna funkcija funkcije f. Stoga postoji $c \in \mathbb{R}$ takvo da za svako $x \in [a, b]$ važi:\\
$\varphi(x) = F(x) + c$. Kako je $\varphi(a) = 0\quad \varphi(a) = F(a) +c$\\
$\varphi(b) = \displaystyle\int^b_a f(t)\text{dt}$ i $\varphi(b) = F(b) + c$ Sledi da je:\\
$\displaystyle\int^b_a f(t)\text{dt} = \varphi(b) = F(b) + c = F(b) + \varphi(a) - F(a) = F(b) - F(a)$
